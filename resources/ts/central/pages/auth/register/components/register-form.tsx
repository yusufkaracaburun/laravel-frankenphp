...
import { IconFacebook, IconGithub } from '@central/assets/brand-icons'
...
import { PasswordInput } from '@central/components/password-input'
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder='John Doe' {...field} data-testid='name-input' />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <PasswordInput placeholder='********' {...field} data-testid='confirm-password-input' />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        />
        <Button className='mt-2' disabled={isLoading} data-testid='register-button'>
          Create Account
        </Button>
